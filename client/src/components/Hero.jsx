...
const links = [    
  ...
  const stats = [    
    ...
    { name: 'Collaboration', value: 'Skill Nation' }   
  ]
        ...
        <div className="mainbg relative isolate overflow-hidden bg-gray-900 py-24 sm:py-32">
          ...
          <div className="mx-auto lg:max-w-7xl px-6 lg:px-8">
            <div className="md:max-w-xl lg:mx-0 bg-yellow-50 text-gray-900 p-8 opacity-70">
              <h2 className="text-blue-700 text-4xl font-bold tracking-tight sm:text-6xl">Digital Literacy & Skill Development Society</h2>
              <p className="mt-6 text-lg leading-8">
              Empowering Today for a Digital Tomorrow: Bridging Skills, Building Futures"
              </p>
            </div>
